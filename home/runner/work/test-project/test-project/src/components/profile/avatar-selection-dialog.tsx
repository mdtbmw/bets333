...
import { useProfile, avatarSeeds } from '@/lib/state/profile';
...
export function AvatarSelectionDialog({ isOpen, onOpenChange, onSave }: AvatarSelectionDialogProps) {
    const { profile } = useProfile();
    const { toast } = useToast();
    const [selectedSeed, setSelectedSeed] = useState(profile.username || 'Daniel');
